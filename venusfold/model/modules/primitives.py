...
from venusfold.model.triangular.layers import LayerNorm, trunc_normal_init_
...
class Attention(nn.Module):
    ...
    def _wrap_up(
        ...
        Args:
            ...
            q_x (torch.Tensor): the input for gated g
                [..., Q, c_q]
            gate_bias (torch.Tensor, optional): additive gate logits.
                [..., Q, H * C_hidden]
        ...
        if self.linear_g is not None:
            gate_logits = self.linear_g(q_x)
            if gate_bias is not None:
                gate_logits = gate_logits + gate_bias.to(dtype=gate_logits.dtype)
    ...
    def forward(
        ...
        Args:
            ...
            gate_bias (torch.Tensor, optional): additive gate logits. Defaults to None.
        ...
        o = self._wrap_up(o, q_x, gate_bias=gate_bias)  # q_x: [*, Q, c_q]
