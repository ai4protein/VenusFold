...
from venusfold.data.constants import STD_RESIDUES_WITH_GAP
from venusfold.model.modules.activation import make_activation
from venusfold.model.modules.primitives import LinearNoBias, Transition
from venusfold.model.modules.transformer import AttentionPairBias
from venusfold.model.modules.fused_ops import dropout_add_rowwise
from venusfold.model.triangular.layers import DropoutRowwise, LayerNorm, OuterProductMean
from venusfold.model.triangular.triangular import (
    TriangleAttention,
...
class TemplateEmbedder(nn.Module):
    ...
    Args:
        ...
        hidden_scale_up (bool, optional): whether scale up the hidden if c_z scales. Defaults to False.
        local_activation (str, optional): local output activation. Defaults to "relu".
    """
    ...
    def __init__(
        ...
        self.activation = make_activation(local_activation)
    ...
    def forward(
        ...
        if "template_aatype" not in input_feature_dict or self.n_blocks < 1:
            # Compatible with the VenusFold 0.5.0 model series
            return 0
        ...
        u = self.linear_no_bias_u(self.activation(u))
