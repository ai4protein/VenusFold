...
- `Term`: a wrapper around a potential implementation from
  `venusfold.tfg.potentials`, with an evaluation interval, a weight schedule, and
...
from venusfold.tfg import potentials
...
class Term:
    ...
    A term wraps:
    - a potential implementation (from `venusfold.tfg.potentials`),
