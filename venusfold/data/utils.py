...
from venusfold.data.core.ccd import biotite_load_ccd_cif
from venusfold.utils.file_io import load_gzip_pickle, read_indices_csv
...
def get_antibody_clusters() -> set[str]:
    ...
    try:
        ...
        raise FileNotFoundError(
            ...
            + "Run scripts/download_inference_data.sh before inference."
        )
