...
from venusfold.data.constants import STD_RESIDUES
from venusfold.data.core.filter import Filter
from venusfold.data.core.parser import AddAtomArrayAnnot, MMCIFParser
from venusfold.data.utils import (
    get_lig_lig_bonds,
...
def atom_array_to_input_json(
    ...
    Args:
        ...
        parser (MMCIFParser): Instantiated VenusFold MMCIFParer.
    ...
    Returns:
        dict: VenusFold input json dict.
    """
...
def cif_to_input_json(
    ...
    """
    Convert mmcif file to VenusFold input json file.
