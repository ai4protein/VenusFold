...
from venusfold.data.esm.esm_featurizer import ESMFeaturizer
from venusfold.data.inference.json_to_feature import SampleDictToFeatures
from venusfold.data.msa.msa_featurizer import InferenceMSAFeaturizer
from venusfold.data.template.template_featurizer import InferenceTemplateFeaturizer
from venusfold.data.template.template_utils import TemplateHitFeaturizer
from venusfold.data.utils import data_type_transform, make_dummy_feature
from venusfold.utils.distributed import DIST_WRAPPER
from venusfold.utils.torch_utils import collate_fn_identity, dict_to_tensor
        ...
        if self.use_template:
            ...
            if not fetch_remote:
                assert template_mmcif_dir is not None and os.path.exists(
                    ...
                    "The mmcif directory containing cif files should be placed under $VENUSFOLD_ROOT_DIR/mmcif.\n"
                    "You can download it from PDB https://www.wwpdb.org/ftp/pdb-ftp-sites or\n"
                    "refer to scripts/database/download_venusfold_data.sh to download inference dependency files, "
