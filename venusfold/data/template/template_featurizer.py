...
from venusfold.data.constants import (
    DNA_CHAIN,
    LIGAND_CHAIN_TYPES,
    PROTEIN_CHAIN,
    RNA_CHAIN,
)
from venusfold.data.msa.msa_utils import map_to_standard
from venusfold.data.template.template_parser import HHRParser, HmmsearchA3MParser
from venusfold.data.template.template_utils import (
...
from venusfold.data.utils import pad_to
from venusfold.utils.file_io import load_json_cached
...
class TemplateFeatureAssemblyLine:
    """
    Orchestrates the conversion of raw templates into finalized VenusFold features.
...
class Templates:
    ...
    def as_venusfold_dict(self) -> BatchDict:
        """Compute additional features and return as VenusFold dictionary."""
